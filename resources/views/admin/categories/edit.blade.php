                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="status" value="Active" @if (old('status', $category->status) == 'Active') checked @endif checked>
                          <label class="form-check-label">Active</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="status" value="Draft" @if (old('status', $category->status) == 'Draft') checked @endif>
