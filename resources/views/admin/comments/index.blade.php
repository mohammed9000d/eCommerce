            ...
            <tbody>
                @foreach ($comments as $comment)
                    <tr>
                        ...
                        <td>
                            {{-- <a href="{{ route('comments.edit', [$comment->id]) }}" class="btn btn-outline-primary">Edit <i class="far fa-edit"></i></a> --}}
                            <a href="#" onclick = "confirmDelete(this,'{{ $comment->id }}')" class="btn btn-outline-danger">delete <i class="far fa-trash-alt"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
