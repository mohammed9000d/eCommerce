                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('parent_id') is-invalid @enderror" name="parent_id">
                          ...
                          @foreach ($parents as $parent)
                            <option value="{{ $parent->id }}" @if (old('parent_id', $product->parent_id) == $parent->id ) selected @endif>{{ $parent->name }}</option>
                          @endforeach
                        </select>
                        @error('parent_id')
                            <p class="text-danger">{{ $message }}</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="status" value="Active" @if (old('status', $product->status) == 'Active') checked @endif checked>
