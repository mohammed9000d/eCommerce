            ...
            enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('quantitiy') is-invalid @enderror" id="quantitiy" name="quantitiy" value="{{ old('quantitiy') }}">
                        @error('quantitiy')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('width') is-invalid @enderror" id="width" name="width" value="{{ old('width') }}">
                        @error('width')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
